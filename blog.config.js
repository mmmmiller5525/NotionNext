...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Sinopectech', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Original Design Manufacturer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.sinopectechlimited.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Figures, Toys', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，welcome to the world of figures',
