const CONFIG = {
  ...
  // 首页大图英雄板块
  LANDING_HERO_TITLE_1: 'Sinopec Technologies',
  LANDING_HERO_P_1: 'Chinese Action Figure Design and Manufacturer',
  LANDING_HERO_BUTTON_1_TEXT: 'Start Experiencing The Journey',
